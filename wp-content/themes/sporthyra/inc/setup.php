...
function understrap_setup() {
	...
	register_nav_menus( array(
		'primary-xl' => __( 'Primary Menu xl', 'understrap' ),
	) );
	
	register_nav_menus( array(
		'primary-lg' => __( 'Primary Menu lg', 'understrap' ),
	) );
	
	register_nav_menus( array(
		'primary-md' => __( 'Primary Menu md', 'understrap' ),
	) );
	
	register_nav_menus( array(
		'primary-sm' => __( 'Primary Menu sm', 'understrap' ),
	) );
	
	register_nav_menus( array(
		'primary-xs' => __( 'Primary Menu xs', 'understrap' ),
	) );
	
	// Secondary menu, md up only
	register_nav_menus( array(
		'secondary-md-up' => __( 'Secondary menu ms up', 'understrap' ),
	) );
