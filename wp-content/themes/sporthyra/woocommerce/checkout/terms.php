...
if ( $terms_page_id > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) :
	...
	<p class="form-row terms wc-terms-and-conditions">
		<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
			<input type="checkbox" class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox" name="terms" <?php checked( apply_filters( 'woocommerce_terms_is_checked_default', isset( $_POST['terms'] ) ), true ); ?> id="terms" /> <span>Jag har läst och godkänner de för sporthyra.se gällande <a href="<?php echo wc_get_page_permalink( 'terms' ); ?>">allmänna och särskilda villkoren</a> samt <a href="https://www.sporthyra.se/integritetspolicy">integritetspolicyn</a></span><span class="required">*</span>
		</label>
